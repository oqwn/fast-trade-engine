...
public class MarketDataController {
    ...
    public ResponseEntity<OHLCResponse> getOHLC(
        ...
        long intervalMillis = parseInterval(interval);
        List<MarketDataService.OHLCData> ohlcData = 
            marketDataService.getHistoricalOHLC(symbol, intervalMillis, periods);
        
        return ResponseEntity.ok(OHLCResponse.from(symbol, interval, ohlcData));
    }
